...
<html>
	...
	<nav class="gtco-nav" role="navigation">
		<div class="gtco-container">
			<div class="row">
				<div class="col-xs-2">
					<div id="gtco-logo"><a id="logo-page-shop" href="${pageContext.request.contextPath }">JoT Official.</a></div>
				</div>
				<div class="col-xs-8 text-center menu-1">
					<ul class="menu-shop">
						...
						<li>
							<a href="${pageContext.request.contextPath }/shoppingcart" id="cart"><i class="icon-shopping-cart"></i> Cart <span class="badge" id="numbercart">${numberOrder }</span></a>
						</li>
					</ul>
				</div>
				<div class="col-xs-2 text-right hidden-xs menu-2">
					<ul>
						<li class="btn-cta-shop"><a href="${pageContext.request.contextPath }/login"><span>Login</span></a></li>
					</ul>
				</div>
	...
	<header id="gtco-header" class="gtco-cover-shop" role="banner" style="background-image:url(${pageContext.request.contextPath }/templates/public/images/header.jpg);">
		<div class="gtco-container">
			<div class="row">
